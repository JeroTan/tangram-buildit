...
1. **Check State & Analyze**
   ...
   - **If it DOES NOT exist (Creation Mode):** Review the user's input. If the idea is omitted or vague, you MUST ask: "What is the general idea of the app you want to build?"
