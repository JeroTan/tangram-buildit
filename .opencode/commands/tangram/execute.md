...
2. **The Feature Plan**: Task summaries in features/ID_name/plan.md.
...
1. **Identify Target Feature**
   Scan features/ for active workspaces. If multiple exist and none were specified in the trigger, use **AskUserQuestion** to let the user select.

2. **Context Subagent Protocol (The Brain Sync)**
...
3. **Determine Execution Pace (The Interview)**
...
4. **The Execution Loop**
   ...
   - **Documentation**: Update the features/ID_name/summary.md with a log of changes.
   - **Checkbox Sync**: Mark the task as complete [x] in features/ID_name/plan.md.
   - **Pattern Alignment**: Ensure the code matches the "signature" found in the archive/.

5. **Task Verification**
   After each task or batch, perform an "Internal Reality Check":
...
> - [Path/to/file2]
>
> **Status:** Verification pending user review. Ready for next batch or /tangram:debug.
